...
from .asignar_cuestionario import asignar_cuestionario                        # asignacion a paciente registrado
from .asignar_pendiente import asignar_pendiente                              # asignacion a invitado no registrado
...
from .crear_gad7 import crear_gad7                                            # HU-019 crear GAD-7
